...
class Responsibility extends StatefulWidget {
  const Responsibility({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: const Text('Public Relations Officer'),
                  ...
                  ListTile(
                    ...
                    horizontalTitleGap: width / 13,
                    title: const Text('Party Commitee Leader'),
                    subtitle: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Mother Teresa University'),
                  ...
                  ListTile(
                    ...
                    horizontalTitleGap: width / 13,
                    title: const Text('Dean of Science'),
                    subtitle: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Mother Teresa University'),
                  ...
                  ListTile(
                    ...
                    horizontalTitleGap: width / 13,
                    title: const Text('Event Manager in Rotract Club, Chennai'),
                    subtitle: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Mother Teresa University'),
                  ...
                  ListTile(
                    ...
                    horizontalTitleGap: width / 13,
                    title: const Text('Red Cross Volunteer'),
                    subtitle: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Mother Teresa University'),
                  ...
                  ListTile(
                    ...
                    horizontalTitleGap: width / 13,
                    title: const Text('Music Producer'),
                    subtitle: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Mother Teresa University'),
